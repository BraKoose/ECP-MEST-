...
export const DashboardOverviewPage = ({ heading1, heading2, heading3, total, pending, resolved, IconLinks }) => {
  ...
  const submissionDataForBar = [
    { name: 'Total', value: totalSubmissions, color: '#2bbbbb' },
    ...
    <div className="px-4 py-6 font-serif bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center">
          <h2 className="text-2xl font-extrabold text-[#2bbbbb] mb-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            <Link to={IconLinks[0].link}>
              <button className="w-full bg-[#2bbbbb] hover:bg-[#25a0a0] text-white font-bold py-3 px-4 rounded-md transition duration-300 ease-in-out flex items-center justify-center">
                <svg
