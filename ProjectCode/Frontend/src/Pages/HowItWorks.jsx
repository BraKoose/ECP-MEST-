  ...
  return (
    <div className="py-20 bg-indigo-50">
      <div className='max-w-6xl mx-auto px-6 lg:px-8'>
        <Heading Heading={"How ECP MEST Works"} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
            ...
            <div className="flex flex-col items-center text-center md:text-right md:items-end p-4 rounded-lg bg-white shadow-md">
              <div className="relative mb-4">
                <div className="w-16 h-16 bg-[#2bbbbb] text-white rounded-full flex items-center justify-center font-bold text-3xl md:absolute md:left-1/2 md:transform md:-translate-x-1/2 md:-top-8 md:z-10 border-4 border-white">
              ...
              <p className="text-gray-700 max-w-md">
                Koose visits the website, clicks "Sign Up," fills out the form with his name, MEST email, and password. He receives a verification email, confirms his account, and then securely logs in to access the dashboard.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center md:text-left md:items-start p-4 rounded-lg bg-white shadow-md">
              ...
              <p className="text-gray-700 max-w-md">
                From the dashboard, Koose clicks "Submit Complaint." He fills in details about the issue, attaches relevant documents or images, provides contact information, and submits his complaint.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center md:text-right md:items-end p-4 rounded-lg bg-white shadow-md">
              ...
              <p className="text-gray-700 max-w-md">
                Upon submission, Koose receives a confirmation. He can then track his complaint's real-time status in the "My Complaints" section and receives email/SMS notifications for updates.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center md:text-left md:items-start p-4 rounded-lg bg-white shadow-md">
              ...
              <p className="text-gray-700 max-w-md">
                Fred, a MEST agent for the Accra Hacker House, reviews Koose's complaint and initiates communication via the system's messaging feature. Koose receives a notification and communicates directly with Fred to discuss further details.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center md:text-right md:items-end p-4 rounded-lg bg-white shadow-md">
              ...
              <p className="text-gray-700 max-w-md">
                Fred resolves the complaint and notifies Koose of the solution (e.g., replacement/repaired). Koose provides feedback on his positive experience with the prompt and courteous service.
              </p>
            </div>
